 ...
 */
final class Version20250802075046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD parent_id INT DEFAULT NULL, DROP parent');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD parent VARCHAR(255) DEFAULT NULL, DROP parent_id');
    }
}
